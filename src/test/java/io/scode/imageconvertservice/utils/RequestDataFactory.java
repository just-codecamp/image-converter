...
public class RequestDataFactory {
    ...
    public List<ImageSource> getSafeImageSources() {
        return getExpectedSafeStrings().stream()
                .map(
                        s -> new ImageSource(s, 200, 200, "")
                ).toList();
    }

    public List<String> getExpectedSafeStrings() {

        List<String> result = new ArrayList<>();

        // Basic Test Strings
        result.add("<div></div><style></style>");
        result.add("<div><span>hello world!</span></div><style></style>");
        result.add("<div><h1>hello world!</h1><span>lorem!</span></div><style></style>");
        result.add("<div><ul><li></li><li></li></ul></div><style></style>");
        result.add("<style></style><div></div>");
        result.add("<div></div>\n" +
                "<style> div { width:100px; height:100px; background-color:red; } </style>");
        result.add("<div></div><style> div { width:100px; height:100px; background-color:red; } </style>");
        result.add("<div> <div></div></div>      <style></style>");
